	...
	model(params) {
		...
		return RSVP.hash({
			...
			cards: this.store.query('card', assign(params, {
				filter: cardFilters,
				include: 'cardset,collections,collections.user,wantedcards,wantedcards.user,wantedcards.wanteddeck,wantedcards.wanteddeck.deck,wantedcards.wanteddeck.deck.cardclass',
